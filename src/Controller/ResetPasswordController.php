        ...
        if ($request->isMethod('POST')) {
            ...
            if ($user) {
                ...
                try {
                    ...
                    // Log the error but still redirect so we don't expose user info
                    // In dev mode: error will appear in the Symfony profiler
                    throw $e; // Re-throw so Symfony shows the error in dev
                }
